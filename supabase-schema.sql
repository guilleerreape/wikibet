...
-- 1. Tabla profiles (se crea automáticamente tras el primer login)
...
-- Daily usage: cada usuario solo ve/edita sus propios registros
...
-- ─── LISTO ────────────────────────────────────────────────────────────────────
-- Ahora ve a Authentication → Providers → Google y activa el provider
-- con el Client ID de Google Cloud Console.
